...
namespace Fal
{
    ...
    public sealed partial class GetOrganizationUsageResponseTimeSerieResultAuthMethodStructured
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationUsageResponseTimeSerieResultAuthMethodStructured" /> class.
        /// </summary>
        /// <param name="detail">
        /// Human-readable summary of the authentication method (key alias, login username, or 'User token'/'None').
        /// </param>
...
#endif
        public GetOrganizationUsageResponseTimeSerieResultAuthMethodStructured(
            string detail,
            string? apiKeyId,
