...
namespace Fal
{
    public partial class ModelsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Fal.GetUsageResponse> GetUsageAsync(
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::Fal.GetUsageResponse2? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::Fal.GetUsageResponse2.FromJson(__content_400, JsonSerializerContext);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Fal.ApiException<global::Fal.GetUsageResponse2>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                global::Fal.GetUsageResponse3? __value_401 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_401 = global::Fal.GetUsageResponse3.FromJson(__content_401, JsonSerializerContext);
                    }
                    else
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Fal.ApiException<global::Fal.GetUsageResponse3>(
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                global::Fal.GetUsageResponse4? __value_403 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_403 = global::Fal.GetUsageResponse4.FromJson(__content_403, JsonSerializerContext);
                    }
                    else
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Fal.ApiException<global::Fal.GetUsageResponse4>(
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                global::Fal.GetUsageResponse5? __value_404 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_404 = global::Fal.GetUsageResponse5.FromJson(__content_404, JsonSerializerContext);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Fal.ApiException<global::Fal.GetUsageResponse5>(
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                global::Fal.GetUsageResponse6? __value_429 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = global::Fal.GetUsageResponse6.FromJson(__content_429, JsonSerializerContext);
                    }
                    else
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Fal.ApiException<global::Fal.GetUsageResponse6>(
