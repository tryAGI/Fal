...
namespace Fal
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Fal.EndPointSecurityRequirement s_GetBillingEventsSecurityRequirement0 =
        ...
        private static readonly global::Fal.EndPointSecurityRequirement[] s_GetBillingEventsSecurityRequirements =
            new global::Fal.EndPointSecurityRequirement[]
            {                s_GetBillingEventsSecurityRequirement0,
            };
        partial void PrepareGetBillingEventsArguments(
        ...
        partial void ProcessGetBillingEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Fal.GetBillingEventsResponse> GetBillingEventsAsync(
            int? limit = default,
        ...
        {
            var __response = await GetBillingEventsAsResponseAsync(
                limit: limit,
                cursor: cursor,
                start: start,
                end: end,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Fal.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Fal.AutoSDKHttpResponse<global::Fal.GetBillingEventsResponse>> GetBillingEventsAsResponseAsync(
            int? limit = default,
            string? cursor = default,
            global::Fal.AnyOf<global::System.DateTime?, string>? start = default,
            global::Fal.AnyOf<global::System.DateTime?, string>? end = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBillingEventsArguments(
            ...
            var __authorizations = global::Fal.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBillingEventsSecurityRequirements,
                operationName: "GetBillingEventsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetBillingEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Fal.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Fal.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBillingEventsAsync",
                                pathTemplate: "\"/models/billing-events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBillingEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Fal.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Fal.GetBillingEventsResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Fal.GetBillingEventsResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.GetBillingEventsResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Fal.GetBillingEventsResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Fal.GetBillingEventsResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.GetBillingEventsResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Fal.GetBillingEventsResponse4? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Fal.GetBillingEventsResponse4.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.GetBillingEventsResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Fal.GetBillingEventsResponse5? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Fal.GetBillingEventsResponse5.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.GetBillingEventsResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Fal.GetBillingEventsResponse6? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Fal.GetBillingEventsResponse6.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.GetBillingEventsResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBillingEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Fal.GetBillingEventsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Fal.AutoSDKHttpResponse<global::Fal.GetBillingEventsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Fal.GetBillingEventsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
