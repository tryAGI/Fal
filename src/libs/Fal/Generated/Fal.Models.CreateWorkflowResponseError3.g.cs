...
namespace Fal
{
    ...
    public sealed partial class CreateWorkflowResponseError3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkflowResponseError3" /> class.
        /// </summary>
        /// <param name="type">
        /// The category of error that occurred
        /// </param>
...
#endif
        public CreateWorkflowResponseError3(
            global::Fal.CreateWorkflowResponseErrorType3 type,
            string message,
            string? docsUrl,
            string? requestId)
        {
