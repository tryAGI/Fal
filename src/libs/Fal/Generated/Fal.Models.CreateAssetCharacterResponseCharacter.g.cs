...
namespace Fal
{
    ...
    public sealed partial class CreateAssetCharacterResponseCharacter
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Fal.JsonConverters.CreateAssetCharacterResponseCharacterTypeJsonConverter))]
        public global::Fal.CreateAssetCharacterResponseCharacterType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAssetCharacterResponseCharacter" /> class.
        /// </summary>
        /// <param name="id">
        /// Collection ID
        /// </param>
...
#endif
        public CreateAssetCharacterResponseCharacter(
            string id,
            string name,
            bool isFavorited,
            string createdAt,
            ...
            global::Fal.CreateAssetCharacterResponseCharacterType type,
            string? description,
            string? icon,
            string? color,
