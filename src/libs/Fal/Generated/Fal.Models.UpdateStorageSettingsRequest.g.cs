...
namespace Fal
{
    ...
    public sealed partial class UpdateStorageSettingsRequest
    {
        ...
        public global::Fal.UpdateStorageSettingsRequestInitialAcl? InitialAcl { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateStorageSettingsRequest" /> class.
        /// </summary>
...
#endif
        public UpdateStorageSettingsRequest(
            int? expirationDurationSeconds,
            global::Fal.UpdateStorageSettingsRequestInitialAcl? initialAcl)
        {
