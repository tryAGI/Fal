...
namespace Fal
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Fal.EndPointSecurityRequirement s_ListRequestsByEndpointSecurityRequirement0 =
        ...
        private static readonly global::Fal.EndPointSecurityRequirement[] s_ListRequestsByEndpointSecurityRequirements =
            new global::Fal.EndPointSecurityRequirement[]
            {                s_ListRequestsByEndpointSecurityRequirement0,
            };
        partial void PrepareListRequestsByEndpointArguments(
            ...
            ref global::Fal.ListRequestsByEndpointStatus? status,
            ref global::System.Guid? requestId,
            ref global::Fal.AnyOf<string, global::System.Collections.Generic.IList<string>>? expand,
            ref global::Fal.ListRequestsByEndpointSortBy? sortBy);
        partial void PrepareListRequestsByEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Fal.ListRequestsByEndpointStatus? status,
            global::System.Guid? requestId,
            global::Fal.AnyOf<string, global::System.Collections.Generic.IList<string>>? expand,
            global::Fal.ListRequestsByEndpointSortBy? sortBy);
        partial void ProcessListRequestsByEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRequestsByEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Fal.ListRequestsByEndpointResponse> ListRequestsByEndpointAsync(
            global::Fal.AnyOf<string, global::System.Collections.Generic.IList<string>> endpointId,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Fal.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListRequestsByEndpointSecurityRequirements,
                operationName: "ListRequestsByEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListRequestsByEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Fal.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Fal.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListRequestsByEndpointAsync",
                                pathTemplate: "\"/models/requests/by-endpoint\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRequestsByEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Fal.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Fal.ListRequestsByEndpointResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Fal.ListRequestsByEndpointResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Fal.ListRequestsByEndpointResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Fal.ListRequestsByEndpointResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.ListRequestsByEndpointResponse7>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRequestsByEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
