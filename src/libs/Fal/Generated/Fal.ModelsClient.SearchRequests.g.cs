...
namespace Fal
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Fal.EndPointSecurityRequirement s_SearchRequestsSecurityRequirement0 =
        ...
        private static readonly global::Fal.EndPointSecurityRequirement[] s_SearchRequestsSecurityRequirements =
            new global::Fal.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Fal.SearchRequestsResponse> SearchRequestsAsync(
            int? limit = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Fal.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Fal.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchRequestsAsync",
                ...
                else
                {
                    await global::Fal.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Fal.SearchRequestsResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Fal.SearchRequestsResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.SearchRequestsResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Fal.SearchRequestsResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Fal.SearchRequestsResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Fal.ApiException<global::Fal.SearchRequestsResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.SearchRequestsResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.SearchRequestsResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Fal.ApiException<global::Fal.SearchRequestsResponse6>.Create(
                                    statusCode: __response.StatusCode,
