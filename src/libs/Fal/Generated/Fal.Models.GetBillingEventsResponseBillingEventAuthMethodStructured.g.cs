...
namespace Fal
{
    ...
    public sealed partial class GetBillingEventsResponseBillingEventAuthMethodStructured
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBillingEventsResponseBillingEventAuthMethodStructured" /> class.
        /// </summary>
        /// <param name="detail">
        /// Human-readable summary of the authentication method (key alias, login username, or 'User token'/'None').
        /// </param>
...
#endif
        public GetBillingEventsResponseBillingEventAuthMethodStructured(
            string detail,
            string? apiKeyId,
