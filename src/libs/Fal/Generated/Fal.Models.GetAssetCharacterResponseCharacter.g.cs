...
namespace Fal
{
    ...
    public sealed partial class GetAssetCharacterResponseCharacter
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Fal.JsonConverters.GetAssetCharacterResponseCharacterTypeJsonConverter))]
        public global::Fal.GetAssetCharacterResponseCharacterType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetCharacterResponseCharacter" /> class.
        /// </summary>
        /// <param name="id">
        /// Collection ID
        /// </param>
...
#endif
        public GetAssetCharacterResponseCharacter(
            string id,
            string name,
            bool isFavorited,
            string createdAt,
