...
namespace Fal
{
    ...
    public sealed partial class UpdateAssetCharacterResponseCharacter
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Fal.JsonConverters.UpdateAssetCharacterResponseCharacterTypeJsonConverter))]
        public global::Fal.UpdateAssetCharacterResponseCharacterType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAssetCharacterResponseCharacter" /> class.
        /// </summary>
        /// <param name="id">
        /// Collection ID
        /// </param>
...
#endif
        public UpdateAssetCharacterResponseCharacter(
            string id,
            string name,
            bool isFavorited,
            string createdAt,
