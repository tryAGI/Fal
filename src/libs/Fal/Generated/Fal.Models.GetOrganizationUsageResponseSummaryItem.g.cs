...
{
    /// <summary>
    /// Aggregate organization usage statistics for the entire date range
    /// </summary>
    public sealed partial class GetOrganizationUsageResponseSummaryItem
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Fal.JsonConverters.GetOrganizationUsageResponseSummaryItemProductJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Fal.GetOrganizationUsageResponseSummaryItemProduct Product { get; set; }
        ...
        public global::Fal.GetOrganizationUsageResponseSummaryItemAuthMethodStructured? AuthMethodStructured { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationUsageResponseSummaryItem" /> class.
        /// </summary>
        /// <param name="username">
        /// Team username within the organization — identifies which team incurred this line item.<br/>
        /// Example: acme-ml-team
...
#endif
        public GetOrganizationUsageResponseSummaryItem(
            string username,
            global::Fal.GetOrganizationUsageResponseSummaryItemProduct product,
            string endpointId,
            string unit,
            double quantity,
            double unitPrice,
