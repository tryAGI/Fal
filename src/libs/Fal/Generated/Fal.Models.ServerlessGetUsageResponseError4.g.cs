...
namespace Fal
{
    ...
    public sealed partial class ServerlessGetUsageResponseError4
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerlessGetUsageResponseError4" /> class.
        /// </summary>
        /// <param name="type">
        /// The category of error that occurred
        /// </param>
...
#endif
        public ServerlessGetUsageResponseError4(
            global::Fal.ServerlessGetUsageResponseErrorType4 type,
            string message,
            string? docsUrl,
            string? requestId)
        {
