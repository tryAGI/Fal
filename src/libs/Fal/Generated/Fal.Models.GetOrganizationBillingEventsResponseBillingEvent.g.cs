...
{
    /// <summary>
    /// Individual organization billing event record with team attribution
    /// </summary>
    public sealed partial class GetOrganizationBillingEventsResponseBillingEvent
    {
        ...
        /// <summary>
        /// Authentication method label resolved across the organization (e.g., 'my-key (owner: acme-ml-team)', 'alice &lt;alice@example.com&gt;', or 'None'). Only populated when 'auth_method' is included in the expand parameter.
        /// </summary>
        ...
        public global::Fal.GetOrganizationBillingEventsResponseBillingEventAuthMethodStructured? AuthMethodStructured { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationBillingEventsResponseBillingEvent" /> class.
        /// </summary>
        /// <param name="username">
        /// Team username that generated this billing event
        /// </param>
...
#endif
        public GetOrganizationBillingEventsResponseBillingEvent(
            string username,
            string requestId,
            string endpointId,
            string timestamp,
            ...
            string? authMethod,
            global::Fal.GetOrganizationBillingEventsResponseBillingEventAuthMethodStructured? authMethodStructured)
        {
