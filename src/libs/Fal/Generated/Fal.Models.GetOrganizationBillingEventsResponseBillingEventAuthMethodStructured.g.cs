...
namespace Fal
{
    ...
    public sealed partial class GetOrganizationBillingEventsResponseBillingEventAuthMethodStructured
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationBillingEventsResponseBillingEventAuthMethodStructured" /> class.
        /// </summary>
        /// <param name="detail">
        /// Human-readable summary of the authentication method (key alias, login username, or 'User token'/'None').
        /// </param>
...
#endif
        public GetOrganizationBillingEventsResponseBillingEventAuthMethodStructured(
            string detail,
            string? apiKeyId,
