...
{
    /// <summary>
    /// Serverless compute usage line item with billing details
    /// </summary>
    public sealed partial class ServerlessGetUsageResponseTimeSerieResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerlessGetUsageResponseTimeSerieResult" /> class.
        /// </summary>
...
#endif
        public ServerlessGetUsageResponseTimeSerieResult(
            string machineType,
            string unit,
            double quantity,
            double unitPrice,
