...
## Features 🔥
- Fully generated C# SDK based on [official Fal.ai OpenAPI specification](https://api.fal.ai/v1/openapi.json) using [OpenApiGenerator](https://github.com/HavenDV/OpenApiGenerator)
